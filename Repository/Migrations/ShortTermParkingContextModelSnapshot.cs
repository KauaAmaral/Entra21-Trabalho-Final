            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 21, 24, 28, 922, DateTimeKind.Local).AddTicks(1988))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime?>("UpdatedAt")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 21, 24, 28, 922, DateTimeKind.Local).AddTicks(2310))
                        .HasColumnName("update_at");
