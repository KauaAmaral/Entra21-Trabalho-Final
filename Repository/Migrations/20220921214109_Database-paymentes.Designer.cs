...
namespace Entra21.CSharp.Area21.Repository.Migrations
{
    ...
    [Migration("20220921214109_Database-paymentes")]
    partial class Databasepaymentes
    {
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 18, 41, 9, 377, DateTimeKind.Local).AddTicks(657))
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 9, 21, 18, 41, 9, 377, DateTimeKind.Local).AddTicks(2330),
