...
namespace Entra21.CSharp.Area21.Repository.Migrations
{
    ...
    [Migration("20220929235856_RemocaoRequired")]
    partial class RemocaoRequired
    {
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 29, 20, 58, 56, 484, DateTimeKind.Local).AddTicks(367))
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 29, 20, 58, 56, 483, DateTimeKind.Local).AddTicks(3927))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime?>("UpdatedAt")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 29, 20, 58, 56, 483, DateTimeKind.Local).AddTicks(4501))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 29, 20, 58, 56, 482, DateTimeKind.Local).AddTicks(8696))
                        .HasColumnName("created_at");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 9, 29, 20, 58, 56, 483, DateTimeKind.Local).AddTicks(517),
