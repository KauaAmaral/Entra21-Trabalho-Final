...
namespace Entra21.CSharp.Area21.Repository.Migrations
{
    ...
    [Migration("20220921225738_Database-payments-defaultvalues")]
    partial class Databasepaymentsdefaultvalues
    {
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 19, 57, 38, 239, DateTimeKind.Local).AddTicks(4494))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime?>("UpdatedAt")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 19, 57, 38, 239, DateTimeKind.Local).AddTicks(4810))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 19, 57, 38, 238, DateTimeKind.Local).AddTicks(8613))
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 9, 21, 19, 57, 38, 239, DateTimeKind.Local).AddTicks(514),
