...
namespace Entra21.CSharp.Area21.Repository.Migrations
{
    ...
    [Migration("20220921235643_Database-payments-value")]
    partial class Databasepaymentsvalue
    {
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 20, 56, 43, 304, DateTimeKind.Local).AddTicks(4993))
                        .HasColumnName("create_at");
                    ...
                    b.Property<DateTime?>("UpdatedAt")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 20, 56, 43, 304, DateTimeKind.Local).AddTicks(5444))
                        .HasColumnName("update_at");
            ...
            modelBuilder.Entity("Entra21.CSharp.Area21.Repository.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DATETIME2")
                        .HasDefaultValue(new DateTime(2022, 9, 21, 20, 56, 43, 303, DateTimeKind.Local).AddTicks(9673))
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 9, 21, 20, 56, 43, 304, DateTimeKind.Local).AddTicks(1499),
