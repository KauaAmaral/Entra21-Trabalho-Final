...
namespace Entra21.CSharp.Area21.Service.EntitiesMappings.Users
{
    public interface IUserEntityMapping
    {
        ...
        User UpdateWithAdministrator(User user, UserUpdateAdministratorViewModel viewModel);
        User UpdatePasswordWith(User user, UserChangePasswordViewModel viewModel);
    }
}
